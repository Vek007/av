...
namespace ListImgControl
{
    public partial class ListImgCtrl : UserControl
    {
        ...
        public ListImgCtrl()
        {
            ...
            {
                if (t.BaseType == typeof(ImageListViewLib.ImageListView.ImageListViewRenderer))
                {
        ...
        {
            ;
            imageListView1.Items.Add(fileName, infoTag == null ? string.Empty : infoTag, tag);
        ...
        public ImageListView.ImageListViewItemCollection GetImgs()
        {
        ...
        void Application_Idle(object sender, EventArgs e)
        {
            ...
            thumbnailsToolStripButton.Checked = (imageListView1.View == ImageListViewLib.View.Thumbnails);
            detailsToolStripButton.Checked = (imageListView1.View == ImageListViewLib.View.Details);
            galleryToolStripButton.Checked = (imageListView1.View == ImageListViewLib.View.Gallery);
            paneToolStripButton.Checked = (imageListView1.View == ImageListViewLib.View.Pane);
        ...
        {
            string folder = ListImgControl.Properties.Settings.Default.LastFolder;
        ...
        private void UpdateStatus()
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    UpdateStatus(string.Format("{0} with Tags - {1}", imageListView1.Items.FocusedItem.FileName, imageListView1.Items.FocusedItem.InfoTags)); ;
                }
            }
        }
        #endregion
