...
namespace ImageListViewLib
{
    ...
    public class ImageListViewItem
    {
        ...
        /// <summary>
        /// Gets or sets the Information tags associated with this item. 
        /// </summary>
        [Category("Appearance"), Browsable(true), Description("Shows different categories for sortin and viewing.")]
        ...
        /// </summary>
        /// <param name="filename">The image filename representing the item.</param>
        /// <param name="infoTags">information related sorting and viewing.</param>
        /// <param name="phTag">original object</param>
        public ImageListViewItem(string filename, string infoTags, Object phTag)
            : this()
        {
            mFileName = filename;
            mInfoTags = infoTags;
